...
class HideUnhideView(ui.View):
    ...
    async def hide(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:olympusChannel:1297340969137471650> **Channel**: {self.channel.mention}\n<:olympusReason:1295595129809141812> **Status**: Hidden\n<:olympusArrow:1297341001341599797> **Reason:** Hide request by {self.author}",
            color=0x000000
        )
...
class Unhide(commands.Cog):
    ...
    async def unhide_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:olympusChannel:1297340969137471650> **Channel**: {channel.mention}\n<:olympusReason:1295595129809141812> **Status**: Unhidden\n<:olympusArrow:1297341001341599797> **Reason:** Unhide request by {ctx.author}",
            color=self.color
        )
